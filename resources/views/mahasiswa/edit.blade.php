...
@section('content')
    ...
    <div class="bg-white shadow-md rounded-lg p-6">
        <form action="{{ route('mahasiswa.update', $mahasiswa->nim) }}" method="POST">
            @csrf
            @method('PUT') {{-- Penting untuk method Edit --}}
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="nim" id="nim" class="form-input" value="{{ old('nim', $mahasiswa->nim) }}"
                           inputmode="numeric" 
                           pattern="[0-9]+" 
                ...
                <div>
                    ...
                    <input type="text" name="nama" id="nama" class="form-input" value="{{ old('nama', $mahasiswa->nama) }}" required>
                ...
                <div>
                    ...
                    <input type="text" name="jurusan" id="jurusan" class="form-input" value="{{ old('jurusan', $mahasiswa->jurusan) }}" required>
                ...
                <div>
                    ...
                    <input type="text" name="angkatan" id="angkatan" class="form-input" value="{{ old('angkatan', $mahasiswa->angkatan) }}"
                           inputmode="numeric" 
                           pattern="[0-9]{4}" 
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="no_hp" id="no_hp" class="form-input" value="{{ old('no_hp', $mahasiswa->no_hp) }}"
                           inputmode="tel" 
                           pattern="[0-9]{10,15}" 
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="alamat" id="alamat" rows="3" class="form-input">{{ old('alamat', $mahasiswa->alamat) }}</textarea>
